...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(TipoSolicitacaoNaoEncontradoException.class)
	public ResponseEntity<?> tipoSolicitacaoNaoEncontradoException(TipoSolicitacaoNaoEncontradoException ex,
			WebRequest request) {
